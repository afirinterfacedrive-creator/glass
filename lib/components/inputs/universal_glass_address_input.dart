...
class UniversalGlassAddressInput extends StatefulWidget {
  ...
  const UniversalGlassAddressInput({
    super.key,
    this.controller,
    this.focusNode,
    this.hintText,
  ...
  @override
  State<UniversalGlassAddressInput> createState() => _UniversalGlassAddressInputState();
}

class _UniversalGlassAddressInputState extends State<UniversalGlassAddressInput> {
  ...
  @override
  void didUpdateWidget(covariant UniversalGlassAddressInput oldWidget) {
  ...
  Widget build(BuildContext context) {
    ...
    // TEXT FIELD
    // ========================================================================
    final Widget addressTextField = TextField(
      ...
      cursorColor: decoration.effectiveFocusColor,
      decoration: InputDecoration(
        ...
        hintText: widget.hintText?? 'Adresse',
    ...
    // Si leadingChild custom, on le wrap. Sinon icone par défaut
    // ========================================================================
    final Widget leadingBubble = GlassActionIcon(
      icon: widget.leadingChild == null? Icons.location_on_outlined : null,
      // ignore: sort_child_properties_last
      child: widget.leadingChild, // <-- support du child custom
      enabled: widget.enabled,
      size: 46,
      isActive: _hasFocus,
