...
class UniversalGlassPhoneInputView extends StatelessWidget {
  ...
  Widget _buildPhoneInput({
    ...
    // TEST 21
    //
    // Le notch est maintenant UNIQUEMENT VISUEL.
    //
    // Aucun ClipPath.
    // Aucun CustomClipper.
    // Aucun NotchClipper.
    //
    // Le TextFormField reste dans l'arbre interactif normal.
    // -------------------------------------------------------------------------

    final double notchStart =
        geo.notchStart;
const double notchRightCorrection = 30.0;

final double notchWidth =
    geo.getLabelWidth(widget.label) -
    notchRightCorrection;
          ...
          SizedBox(
            ...
            child: Stack(
              ...
              children: [
                ...
                // =================================================================
                // TEST 21 — NOTCH VISUEL
                // =================================================================
                //
                // Le notch est dessiné par CustomPainter.
                //
                // IMPORTANT :
                //
                // IgnorePointer = aucune interception de clic.
                // CustomPaint = aucun clipping.
                //
                // Le TextFormField reste totalement indépendant.
                // =================================================================
                ...
                if (isFloating)
                  Positioned.fill(
                    child: IgnorePointer(
                      ...
                      borderWidth:
                          hasFocus
                              ? decoration.safeFocusBorderWidth
                              : decoration.safeBorderWidth,
...
// ============================================================================
// NOTCH PAINTER — TEST 21
// ============================================================================
//
// Purement visuel.
//
// AUCUN clipping.
// AUCUNE gestion du hit-test.
// AUCUNE modification du FocusNode.
//
// Le painter dessine uniquement la zone du notch.
// ============================================================================
...
class _PhoneInputNotchPainter
  ...
  void paint(
    ...
    final Path notchBackground =
        Path();

    notchBackground.moveTo(
      start - notchRadius,
      0,
    );

    notchBackground.quadraticBezierTo(
      start,
      0,
      start,
      notchRadius,
