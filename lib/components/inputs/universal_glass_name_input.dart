...
class UniversalGlassNameInput extends StatefulWidget {
  ...
  @override
  State<UniversalGlassNameInput> createState() => _UniversalGlassNameInputState();
}

class _UniversalGlassNameInputState extends State<UniversalGlassNameInput> {
  ...
  @override
  void didUpdateWidget(covariant UniversalGlassNameInput oldWidget) {
  ...
  Widget build(BuildContext context) {
    ...
    // TEXT FIELD
    // ========================================================================
    final Widget nameTextField = TextField(
      ...
      decoration: InputDecoration(
        ...
        hintText: widget.hintText?? 'Nom complet',
    ...
    final Widget leadingBubble = GlassActionIcon(
      icon: widget.leadingChild == null? Icons.person_outline_rounded : null,
