...
/// ============================================================================
/// UNIVERSAL GLASS EMAIL INPUT
/// Avec GlassSurfaceContainer pour le hover glass synchro
/// ============================================================================

class UniversalGlassEmailInput extends StatefulWidget {
  ...
  const UniversalGlassEmailInput({
    super.key,
    this.controller,
    this.focusNode,
    this.hintText,
  ...
  @override
  State<UniversalGlassEmailInput> createState() => _UniversalGlassEmailInputState();
}

class _UniversalGlassEmailInputState extends State<UniversalGlassEmailInput> {
  ...
  @override
  void didUpdateWidget(covariant UniversalGlassEmailInput oldWidget) {
  ...
  Widget build(BuildContext context) {
    ...
    // TEXT FIELD
    // ========================================================================
    final Widget emailTextField = TextField(
      ...
      decoration: InputDecoration(
        ...
        hintText: widget.hintText?? 'Adresse email',
    ...
    final Widget leadingBubble = GlassActionIcon(
      icon: widget.leadingChild == null? Icons.alternate_email_rounded : null,
      // ignore: sort_child_properties_last
      child: widget.leadingChild ?? const Text('@', textAlign: TextAlign.center, style: TextStyle(color: Colors.white, fontSize: 18, fontWeight: FontWeight.w800, height: 1.0)),
      enabled: widget.enabled,
      size: 46,
      isActive: _hasFocus || hasError,
      onTap: widget.enabled && !widget.readOnly? _handleLeadingTap : null,
      useTintedIcon: widget.leadingChild == null, // true si icon, false si Text('@')
    );

    // ========================================================================
    // SUFFIX -> GLASSACTIONICON
    // ========================================================================
    final Widget? suffixButton = widget.suffixIcon!= null? GlassActionIcon(
    ...
    final Widget content = Row(
      ...
      children: [
        ...
        if (suffixButton!= null)...[const SizedBox(width: 8), suffixButton],
      ],
    );
